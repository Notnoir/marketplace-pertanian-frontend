      ...
      <div className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="flex space-x-8">
            ...
            <Link to="/admin/transactions" className="py-4 px-1 border-b-2 border-orange-500 text-orange-600 font-medium text-sm">
              Transaksi
            </Link>
          </nav>
        </div>
        ...
        <div className="mb-8">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div className="mb-4 sm:mb-0">
              ...
              <p className="mt-1 text-sm text-gray-500">Kelola dan pantau semua transaksi di platform</p>
            </div>
              ...
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    ...
                    <dd className="text-lg font-semibold text-gray-900">{stats.menunggu}</dd>
                  </dl>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    ...
                    <dd className="text-lg font-semibold text-gray-900">{stats.diproses}</dd>
                  </dl>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    ...
                    <dd className="text-lg font-semibold text-gray-900">{stats.selesai}</dd>
                  </dl>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    ...
                    <dd className="text-lg font-semibold text-gray-900">{stats.dibatalkan}</dd>
                  </dl>
                </div>
              </div>
            </div>
        ...
        <div className="bg-white shadow-sm rounded-lg border overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-200">
            ...
            <p className="mt-1 text-sm text-gray-500">
              ...
              {statusFilter !== "all" && ` dengan status ${statusFilter.toLowerCase()}`}
            </p>
          </div>
          ...
          {filteredTransactions.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="mt-1 text-sm text-gray-500">{statusFilter !== "all" ? `Tidak ditemukan transaksi dengan status ${statusFilter.toLowerCase()}.` : "Belum ada transaksi yang terdaftar."}</p>
            </div>
          ) : (
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {filteredTransactions.map((transaction) => (
                    <tr key={transaction.id} className="hover:bg-gray-50 transition-colors">
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center">
                          ...
                          <div className="ml-4">
                            ...
                            <div className="text-sm text-gray-500">{transaction.id.substring(8, 16)}...</div>
                          </div>
                        </div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center">
                          ...
                          <div className="ml-3">
                            <div className="text-sm font-medium text-gray-900">{transaction.user?.nama || "N/A"}</div>
                          </div>
                        </div>
                      </td>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 font-medium">Rp {parseInt(transaction.total_harga).toLocaleString("id-ID")}</td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center">
